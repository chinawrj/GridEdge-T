...
fn launch_agent_starts_only_weekdays_at_0925_and_restarts_only_failures() {
    ...
    let deployment_root = "/Users/rjwang/Library/Application Support/GridEdge-T";
    ...
    let remote_fills = fill_slices
        ...
        .map(|(index, (quantity, price))| {
            ...
            Ok(SimulationFillRecord {
                ...
                contract_id: "6211087926".to_owned(),
                fill_id: format!("6211087926-fill-{:02}", index + 1),
